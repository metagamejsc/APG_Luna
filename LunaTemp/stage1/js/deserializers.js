...
Deserializers["LunaManager"] = function (request, data, root) {
  ...
  i560.processBuildRope = i561[13]
  i560.countPlay = i561[14]
  i560.countPlayFinal = i561[15]
  i560.countPlayMax = i561[16]
  i560.timeDropFinal = i561[17]
  i560.colorBG = new pc.Color(i561[18], i561[19], i561[20], i561[21])
  request.r(i561[22], i561[23], 0, i560, 'texture2D')
  request.r(i561[24], i561[25], 0, i560, 'rawImageBG')
...
Deserializers["DropID"] = function (request, data, root) {
  var i598 = root || request.c( 'DropID' )
  var i599 = data
  request.r(i599[0], i599[1], 0, i598, 'mixSkeletonSkin')
  return i598
}

Deserializers["Luna.Unity.DTO.UnityEngine.Components.PolygonCollider2D"] = function (request, data, root) {
  var i600 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.PolygonCollider2D' )
  var i601 = data
  i600.usedByComposite = !!i601[0]
  i600.autoTiling = !!i601[1]
  var i603 = i601[2]
  var i602 = []
  ...
  for(var i = 0; i < i605.length; i += 2) {
    i604.push( new pc.Vec2( i605[i + 0], i605[i + 1] ) );
  }
    i602.push( i604 );
  }
  i600.points = i602
  i600.enabled = !!i601[3]
  i600.isTrigger = !!i601[4]
  i600.usedByEffector = !!i601[5]
  i600.density = i601[6]
  i600.offset = new pc.Vec2( i601[7], i601[8] )
  request.r(i601[9], i601[10], 0, i600, 'material')
  return i600
}
...
Deserializers["DragID"] = function (request, data, root) {
  var i638 = root || request.c( 'DragID' )
  var i639 = data
  i638.idDrag = i639[0]
  i638.isProcess = !!i639[1]
  return i638
}

Deserializers["Luna.Unity.DTO.UnityEngine.Components.CanvasGroup"] = function (request, data, root) {
  var i640 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.CanvasGroup' )
  var i641 = data
  i640.m_Alpha = i641[0]
  i640.m_Interactable = !!i641[1]
  i640.m_BlocksRaycasts = !!i641[2]
  i640.m_IgnoreParentGroups = !!i641[3]
  i640.enabled = !!i641[4]
  return i640
}

Deserializers["DraggableItem"] = function (request, data, root) {
  var i642 = root || request.c( 'DraggableItem' )
  var i643 = data
  i642.idDrag = i643[0]
  i642.isProcess = !!i643[1]
  i642.isLose = !!i643[2]
  i642.isHide = !!i643[3]
  return i642
}
...
Deserializers["DropZone"] = function (request, data, root) {
  var i644 = root || request.c( 'DropZone' )
  var i645 = data
  i644.idDrop = i645[0]
  var i647 = i645[1]
  var i646 = []
  ...
  i644.steps = i646
  request.r(i645[2], i645[3], 0, i644, 'stepLose')
  return i644
}
...
Deserializers.lunaDaysRunning = "302.1";

Deserializers.lunaVersion = "6.4.0";

Deserializers.lunaSHA = "6639120529aa36186c6141b5c3fb20246c28bff0";

Deserializers.creativeName = "BTTP_V17_NgocBTU_AnhPD";
...
Deserializers.buildID = "1cab0ee9-ab72-4716-8fe5-6e10c4c6ba22";
