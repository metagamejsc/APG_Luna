...
Deserializers["Luna.Unity.DTO.UnityEngine.Components.RectTransform"] = function (request, data, root) {
  var i1496 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.RectTransform' )
  var i1497 = data
  i1496.pivot = new pc.Vec2( i1497[0], i1497[1] )
  i1496.anchorMin = new pc.Vec2( i1497[2], i1497[3] )
  i1496.anchorMax = new pc.Vec2( i1497[4], i1497[5] )
  i1496.sizeDelta = new pc.Vec2( i1497[6], i1497[7] )
  i1496.anchoredPosition3D = new pc.Vec3( i1497[8], i1497[9], i1497[10] )
  i1496.rotation = new pc.Quat(i1497[11], i1497[12], i1497[13], i1497[14])
  i1496.scale = new pc.Vec3( i1497[15], i1497[16], i1497[17] )
  return i1496
}

Deserializers["Luna.Unity.DTO.UnityEngine.Components.CanvasRenderer"] = function (request, data, root) {
  var i1498 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.CanvasRenderer' )
  var i1499 = data
  i1498.cullTransparentMesh = !!i1499[0]
  return i1498
}
...
Deserializers["Luna.Unity.DTO.UnityEngine.Scene.Scene"] = function (request, data, root) {
  var i1520 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Scene.Scene' )
  var i1521 = data
  i1520.name = i1521[0]
  i1520.index = i1521[1]
  i1520.startup = !!i1521[2]
  return i1520
}

Deserializers["Luna.Unity.DTO.UnityEngine.Components.Transform"] = function (request, data, root) {
  var i1522 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.Transform' )
  var i1523 = data
  i1522.position = new pc.Vec3( i1523[0], i1523[1], i1523[2] )
  i1522.scale = new pc.Vec3( i1523[3], i1523[4], i1523[5] )
  i1522.rotation = new pc.Quat(i1523[6], i1523[7], i1523[8], i1523[9])
  return i1522
}

Deserializers["Luna.Unity.DTO.UnityEngine.Components.Camera"] = function (request, data, root) {
  var i1524 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.Camera' )
  var i1525 = data
  i1524.aspect = i1525[0]
  i1524.orthographic = !!i1525[1]
  i1524.orthographicSize = i1525[2]
  i1524.backgroundColor = new pc.Color(i1525[3], i1525[4], i1525[5], i1525[6])
  i1524.nearClipPlane = i1525[7]
  i1524.farClipPlane = i1525[8]
  i1524.fieldOfView = i1525[9]
  i1524.depth = i1525[10]
  i1524.clearFlags = i1525[11]
  i1524.cullingMask = i1525[12]
  i1524.rect = i1525[13]
  request.r(i1525[14], i1525[15], 0, i1524, 'targetTexture')
  i1524.usePhysicalProperties = !!i1525[16]
  i1524.focalLength = i1525[17]
  i1524.sensorSize = new pc.Vec2( i1525[18], i1525[19] )
  i1524.lensShift = new pc.Vec2( i1525[20], i1525[21] )
  i1524.gateFit = i1525[22]
  i1524.commandBufferCount = i1525[23]
  i1524.cameraType = i1525[24]
  i1524.enabled = !!i1525[25]
  return i1524
}
...
Deserializers["Luna.Unity.DTO.UnityEngine.Components.Canvas"] = function (request, data, root) {
  var i1530 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.Canvas' )
  var i1531 = data
  i1530.planeDistance = i1531[0]
  i1530.referencePixelsPerUnit = i1531[1]
  i1530.isFallbackOverlay = !!i1531[2]
  i1530.renderMode = i1531[3]
  i1530.renderOrder = i1531[4]
  i1530.sortingLayerName = i1531[5]
  i1530.sortingOrder = i1531[6]
  i1530.scaleFactor = i1531[7]
  request.r(i1531[8], i1531[9], 0, i1530, 'worldCamera')
  i1530.overrideSorting = !!i1531[10]
  i1530.pixelPerfect = !!i1531[11]
  i1530.targetDisplay = i1531[12]
  i1530.overridePixelPerfect = !!i1531[13]
  i1530.enabled = !!i1531[14]
  return i1530
}

Deserializers["UnityEngine.UI.CanvasScaler"] = function (request, data, root) {
  var i1532 = root || request.c( 'UnityEngine.UI.CanvasScaler' )
  var i1533 = data
  i1532.m_UiScaleMode = i1533[0]
  i1532.m_ReferencePixelsPerUnit = i1533[1]
  i1532.m_ScaleFactor = i1533[2]
  i1532.m_ReferenceResolution = new pc.Vec2( i1533[3], i1533[4] )
  i1532.m_ScreenMatchMode = i1533[5]
  i1532.m_MatchWidthOrHeight = i1533[6]
  i1532.m_PhysicalUnit = i1533[7]
  i1532.m_FallbackScreenDPI = i1533[8]
  i1532.m_DefaultSpriteDPI = i1533[9]
  i1532.m_DynamicPixelsPerUnit = i1533[10]
  i1532.m_PresetInfoIsWorld = !!i1533[11]
  return i1532
}

Deserializers["UnityEngine.UI.GraphicRaycaster"] = function (request, data, root) {
  var i1534 = root || request.c( 'UnityEngine.UI.GraphicRaycaster' )
  var i1535 = data
  i1534.m_IgnoreReversedGraphics = !!i1535[0]
  i1534.m_BlockingObjects = i1535[1]
  i1534.m_BlockingMask = UnityEngine.LayerMask.FromIntegerValue( i1535[2] )
  return i1534
}

Deserializers["LunaManager"] = function (request, data, root) {
  var i1536 = root || request.c( 'LunaManager' )
  var i1537 = data
  var i1539 = i1537[0]
  var i1538 = []
  ...
  i1536.lstBtnInstall = i1538
  request.r(i1537[1], i1537[2], 0, i1536, 'WinGO')
  request.r(i1537[3], i1537[4], 0, i1536, 'LoseGO')
  request.r(i1537[5], i1537[6], 0, i1536, 'StartCard')
  request.r(i1537[7], i1537[8], 0, i1536, 'EndCard')
  request.r(i1537[9], i1537[10], 0, i1536, 'Parent')
  i1536.isDrag = !!i1537[11]
  i1536.timeDrag = i1537[12]
  i1536.countPlay = i1537[13]
  i1536.countPlayFinal = i1537[14]
  i1536.countPlayMax = i1537[15]
  i1536.timeDropFinal = i1537[16]
  i1536.colorBG = new pc.Color(i1537[17], i1537[18], i1537[19], i1537[20])
  request.r(i1537[21], i1537[22], 0, i1536, 'texture2D')
  request.r(i1537[23], i1537[24], 0, i1536, 'rawImageBG')
  request.r(i1537[25], i1537[26], 0, i1536, 'skeDoor')
  request.r(i1537[27], i1537[28], 0, i1536, 'mixSkeletonSkin')
  request.r(i1537[29], i1537[30], 0, i1536, 'textProgess')
  request.r(i1537[31], i1537[32], 0, i1536, 'imgProgess')
  request.r(i1537[33], i1537[34], 0, i1536, 'timeText')
  return i1536
}
...
Deserializers["UnityEngine.UI.Image"] = function (request, data, root) {
  var i1546 = root || request.c( 'UnityEngine.UI.Image' )
  var i1547 = data
  request.r(i1547[0], i1547[1], 0, i1546, 'm_Sprite')
  i1546.m_Type = i1547[2]
  i1546.m_PreserveAspect = !!i1547[3]
  i1546.m_FillCenter = !!i1547[4]
  i1546.m_FillMethod = i1547[5]
  i1546.m_FillAmount = i1547[6]
  i1546.m_FillClockwise = !!i1547[7]
  i1546.m_FillOrigin = i1547[8]
  i1546.m_UseSpriteMesh = !!i1547[9]
  i1546.m_PixelsPerUnitMultiplier = i1547[10]
  i1546.m_Maskable = !!i1547[11]
  request.r(i1547[12], i1547[13], 0, i1546, 'm_Material')
  i1546.m_Color = new pc.Color(i1547[14], i1547[15], i1547[16], i1547[17])
  i1546.m_RaycastTarget = !!i1547[18]
  i1546.m_RaycastPadding = new pc.Vec4( i1547[19], i1547[20], i1547[21], i1547[22] )
  return i1546
}

Deserializers["ClickItem"] = function (request, data, root) {
  var i1548 = root || request.c( 'ClickItem' )
  var i1549 = data
  var i1551 = i1549[0]
  var i1550 = []
  ...
  i1548.steps = i1550
  i1548.currentStep = i1549[1]
  i1548.isProcess = !!i1549[2]
  return i1548
}

Deserializers["UnityEngine.UI.Button"] = function (request, data, root) {
  var i1554 = root || request.c( 'UnityEngine.UI.Button' )
  var i1555 = data
  i1554.m_OnClick = request.d('UnityEngine.UI.Button+ButtonClickedEvent', i1555[0], i1554.m_OnClick)
  i1554.m_Navigation = request.d('UnityEngine.UI.Navigation', i1555[1], i1554.m_Navigation)
  i1554.m_Transition = i1555[2]
  i1554.m_Colors = request.d('UnityEngine.UI.ColorBlock', i1555[3], i1554.m_Colors)
  i1554.m_SpriteState = request.d('UnityEngine.UI.SpriteState', i1555[4], i1554.m_SpriteState)
  i1554.m_AnimationTriggers = request.d('UnityEngine.UI.AnimationTriggers', i1555[5], i1554.m_AnimationTriggers)
  i1554.m_Interactable = !!i1555[6]
  request.r(i1555[7], i1555[8], 0, i1554, 'm_TargetGraphic')
  return i1554
}

Deserializers["UnityEngine.UI.Button+ButtonClickedEvent"] = function (request, data, root) {
  var i1556 = root || request.c( 'UnityEngine.UI.Button+ButtonClickedEvent' )
  var i1557 = data
  i1556.m_PersistentCalls = request.d('UnityEngine.Events.PersistentCallGroup', i1557[0], i1556.m_PersistentCalls)
  return i1556
}

Deserializers["UnityEngine.Events.PersistentCallGroup"] = function (request, data, root) {
  var i1558 = root || request.c( 'UnityEngine.Events.PersistentCallGroup' )
  var i1559 = data
  var i1561 = i1559[0]
  var i1560 = new (System.Collections.Generic.List$1(Bridge.ns('UnityEngine.Events.PersistentCall')))
  for(var i = 0; i < i1561.length; i += 1) {
    i1560.add(request.d('UnityEngine.Events.PersistentCall', i1561[i + 0]));
  }
  i1558.m_Calls = i1560
  return i1558
}
...
Deserializers["UnityEngine.Events.PersistentCall"] = function (request, data, root) {
  var i1564 = root || request.c( 'UnityEngine.Events.PersistentCall' )
  var i1565 = data
  request.r(i1565[0], i1565[1], 0, i1564, 'm_Target')
  i1564.m_TargetAssemblyTypeName = i1565[2]
  i1564.m_MethodName = i1565[3]
  i1564.m_Mode = i1565[4]
  i1564.m_Arguments = request.d('UnityEngine.Events.ArgumentCache', i1565[5], i1564.m_Arguments)
  i1564.m_CallState = i1565[6]
  return i1564
}
...
Deserializers["DragCustom"] = function (request, data, root) {
  var i1576 = root || request.c( 'DragCustom' )
  var i1577 = data
  i1576.idDrag = i1577[0]
  i1576.animationName = i1577[1]
  i1576.isProcess = !!i1577[2]
  return i1576
}

Deserializers["DropCustom"] = function (request, data, root) {
  var i1578 = root || request.c( 'DropCustom' )
  var i1579 = data
  request.r(i1579[0], i1579[1], 0, i1578, 'skeletonGraphic')
  i1578.animationNameDefault = i1579[2]
  request.r(i1579[3], i1579[4], 0, i1578, 'mixSkeletonSkin')
  request.r(i1579[5], i1579[6], 0, i1578, 'skeDoor')
  i1578.numBody = i1579[7]
  var i1581 = i1579[8]
  var i1580 = []
...
Deserializers["Luna.Unity.DTO.UnityEngine.Components.PolygonCollider2D"] = function (request, data, root) {
  var i1588 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Components.PolygonCollider2D' )
  var i1589 = data
  i1588.usedByComposite = !!i1589[0]
  i1588.autoTiling = !!i1589[1]
  var i1591 = i1589[2]
  var i1590 = []
  ...
  for(var i = 0; i < i1593.length; i += 2) {
    i1592.push( new pc.Vec2( i1593[i + 0], i1593[i + 1] ) );
  }
    i1590.push( i1592 );
  }
  i1588.points = i1590
  i1588.enabled = !!i1589[3]
  i1588.isTrigger = !!i1589[4]
  i1588.usedByEffector = !!i1589[5]
  i1588.density = i1589[6]
  i1588.offset = new pc.Vec2( i1589[7], i1589[8] )
  request.r(i1589[9], i1589[10], 0, i1588, 'material')
  return i1588
}

Deserializers["UnityEngine.Events.ArgumentCache"] = function (request, data, root) {
  var i1600 = root || request.c( 'UnityEngine.Events.ArgumentCache' )
  var i1601 = data
  request.r(i1601[0], i1601[1], 0, i1600, 'm_ObjectArgument')
  i1600.m_ObjectArgumentAssemblyTypeName = i1601[2]
  i1600.m_IntArgument = i1601[3]
  i1600.m_FloatArgument = i1601[4]
  i1600.m_StringArgument = i1601[5]
  i1600.m_BoolArgument = !!i1601[6]
  return i1600
}

Deserializers["TMPro.TextMeshProUGUI"] = function (request, data, root) {
  var i1602 = root || request.c( 'TMPro.TextMeshProUGUI' )
  var i1603 = data
  i1602.m_hasFontAssetChanged = !!i1603[0]
  request.r(i1603[1], i1603[2], 0, i1602, 'm_baseMaterial')
  i1602.m_maskOffset = new pc.Vec4( i1603[3], i1603[4], i1603[5], i1603[6] )
  i1602.m_text = i1603[7]
  i1602.m_isRightToLeft = !!i1603[8]
  request.r(i1603[9], i1603[10], 0, i1602, 'm_fontAsset')
  request.r(i1603[11], i1603[12], 0, i1602, 'm_sharedMaterial')
  var i1605 = i1603[13]
  var i1604 = []
  for(var i = 0; i < i1605.length; i += 2) {
  request.r(i1605[i + 0], i1605[i + 1], 2, i1604, '')
  }
  i1602.m_fontSharedMaterials = i1604
  request.r(i1603[14], i1603[15], 0, i1602, 'm_fontMaterial')
  var i1607 = i1603[16]
  var i1606 = []
  for(var i = 0; i < i1607.length; i += 2) {
  request.r(i1607[i + 0], i1607[i + 1], 2, i1606, '')
  }
  i1602.m_fontMaterials = i1606
  i1602.m_fontColor32 = UnityEngine.Color32.ConstructColor(i1603[17], i1603[18], i1603[19], i1603[20])
  i1602.m_fontColor = new pc.Color(i1603[21], i1603[22], i1603[23], i1603[24])
  i1602.m_enableVertexGradient = !!i1603[25]
  i1602.m_colorMode = i1603[26]
  i1602.m_fontColorGradient = request.d('TMPro.VertexGradient', i1603[27], i1602.m_fontColorGradient)
  request.r(i1603[28], i1603[29], 0, i1602, 'm_fontColorGradientPreset')
  request.r(i1603[30], i1603[31], 0, i1602, 'm_spriteAsset')
  i1602.m_tintAllSprites = !!i1603[32]
  request.r(i1603[33], i1603[34], 0, i1602, 'm_StyleSheet')
  i1602.m_TextStyleHashCode = i1603[35]
  i1602.m_overrideHtmlColors = !!i1603[36]
  i1602.m_faceColor = UnityEngine.Color32.ConstructColor(i1603[37], i1603[38], i1603[39], i1603[40])
  i1602.m_fontSize = i1603[41]
  i1602.m_fontSizeBase = i1603[42]
  i1602.m_fontWeight = i1603[43]
  i1602.m_enableAutoSizing = !!i1603[44]
  i1602.m_fontSizeMin = i1603[45]
  i1602.m_fontSizeMax = i1603[46]
  i1602.m_fontStyle = i1603[47]
  i1602.m_HorizontalAlignment = i1603[48]
  i1602.m_VerticalAlignment = i1603[49]
  i1602.m_textAlignment = i1603[50]
  i1602.m_characterSpacing = i1603[51]
  i1602.m_wordSpacing = i1603[52]
  i1602.m_lineSpacing = i1603[53]
  i1602.m_lineSpacingMax = i1603[54]
  i1602.m_paragraphSpacing = i1603[55]
  i1602.m_charWidthMaxAdj = i1603[56]
  i1602.m_enableWordWrapping = !!i1603[57]
  i1602.m_wordWrappingRatios = i1603[58]
  i1602.m_overflowMode = i1603[59]
  request.r(i1603[60], i1603[61], 0, i1602, 'm_linkedTextComponent')
  request.r(i1603[62], i1603[63], 0, i1602, 'parentLinkedComponent')
  i1602.m_enableKerning = !!i1603[64]
  i1602.m_enableExtraPadding = !!i1603[65]
  i1602.checkPaddingRequired = !!i1603[66]
  i1602.m_isRichText = !!i1603[67]
  i1602.m_parseCtrlCharacters = !!i1603[68]
  i1602.m_isOrthographic = !!i1603[69]
  i1602.m_isCullingEnabled = !!i1603[70]
  i1602.m_horizontalMapping = i1603[71]
  i1602.m_verticalMapping = i1603[72]
  i1602.m_uvLineOffset = i1603[73]
  i1602.m_geometrySortingOrder = i1603[74]
  i1602.m_IsTextObjectScaleStatic = !!i1603[75]
  i1602.m_VertexBufferAutoSizeReduction = !!i1603[76]
  i1602.m_useMaxVisibleDescender = !!i1603[77]
  i1602.m_pageToDisplay = i1603[78]
  i1602.m_margin = new pc.Vec4( i1603[79], i1603[80], i1603[81], i1603[82] )
  i1602.m_isUsingLegacyAnimationComponent = !!i1603[83]
  i1602.m_isVolumetricText = !!i1603[84]
  i1602.m_Maskable = !!i1603[85]
  request.r(i1603[86], i1603[87], 0, i1602, 'm_Material')
  i1602.m_Color = new pc.Color(i1603[88], i1603[89], i1603[90], i1603[91])
  i1602.m_RaycastTarget = !!i1603[92]
  i1602.m_RaycastPadding = new pc.Vec4( i1603[93], i1603[94], i1603[95], i1603[96] )
  return i1602
}

Deserializers["TMPro.VertexGradient"] = function (request, data, root) {
  var i1610 = root || request.c( 'TMPro.VertexGradient' )
  var i1611 = data
  i1610.topLeft = new pc.Color(i1611[0], i1611[1], i1611[2], i1611[3])
  i1610.topRight = new pc.Color(i1611[4], i1611[5], i1611[6], i1611[7])
  i1610.bottomLeft = new pc.Color(i1611[8], i1611[9], i1611[10], i1611[11])
  i1610.bottomRight = new pc.Color(i1611[12], i1611[13], i1611[14], i1611[15])
  return i1610
}
...
Deserializers.lunaDaysRunning = "212.1";

Deserializers.lunaVersion = "6.4.0";

Deserializers.lunaSHA = "6639120529aa36186c6141b5c3fb20246c28bff0";

Deserializers.creativeName = "BTTP_V11_AnhPD_AnhPD";
...
Deserializers.buildID = "2f5bb762-0e34-46f8-9f62-65f77c491034";
