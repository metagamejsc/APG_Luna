...
Deserializers["LunaManager"] = function (request, data, root) {
  ...
  request.r(i555[1], i555[2], 0, i554, 'WinGO')
  request.r(i555[3], i555[4], 0, i554, 'LoseGO')
  request.r(i555[5], i555[6], 0, i554, 'StartCard')
  request.r(i555[7], i555[8], 0, i554, 'EndCard')
  request.r(i555[9], i555[10], 0, i554, 'Parent')
  i554.isDrag = !!i555[11]
  i554.timeDrag = i555[12]
  i554.countPlay = i555[13]
  i554.countPlayFinal = i555[14]
  i554.countPlayMax = i555[15]
  i554.timeDropFinal = i555[16]
  i554.colorBG = new pc.Color(i555[17], i555[18], i555[19], i555[20])
  request.r(i555[21], i555[22], 0, i554, 'texture2D')
  request.r(i555[23], i555[24], 0, i554, 'rawImageBG')
  request.r(i555[25], i555[26], 0, i554, 'textProgess')
  request.r(i555[27], i555[28], 0, i554, 'imgProgess')
  request.r(i555[29], i555[30], 0, i554, 'timeText')
  return i554
}
...
Deserializers["ClickItem"] = function (request, data, root) {
  var i572 = root || request.c( 'ClickItem' )
  var i573 = data
  var i575 = i573[0]
  var i574 = []
  ...
  i572.steps = i574
  i572.currentStep = i573[1]
  i572.isProcess = !!i573[2]
  return i572
}

Deserializers["UnityEngine.UI.Button"] = function (request, data, root) {
  var i578 = root || request.c( 'UnityEngine.UI.Button' )
  var i579 = data
  i578.m_OnClick = request.d('UnityEngine.UI.Button+ButtonClickedEvent', i579[0], i578.m_OnClick)
  i578.m_Navigation = request.d('UnityEngine.UI.Navigation', i579[1], i578.m_Navigation)
  i578.m_Transition = i579[2]
  i578.m_Colors = request.d('UnityEngine.UI.ColorBlock', i579[3], i578.m_Colors)
  i578.m_SpriteState = request.d('UnityEngine.UI.SpriteState', i579[4], i578.m_SpriteState)
  i578.m_AnimationTriggers = request.d('UnityEngine.UI.AnimationTriggers', i579[5], i578.m_AnimationTriggers)
  i578.m_Interactable = !!i579[6]
  request.r(i579[7], i579[8], 0, i578, 'm_TargetGraphic')
  return i578
}

Deserializers["UnityEngine.UI.Button+ButtonClickedEvent"] = function (request, data, root) {
  var i580 = root || request.c( 'UnityEngine.UI.Button+ButtonClickedEvent' )
  var i581 = data
  i580.m_PersistentCalls = request.d('UnityEngine.Events.PersistentCallGroup', i581[0], i580.m_PersistentCalls)
  return i580
}

Deserializers["UnityEngine.Events.PersistentCallGroup"] = function (request, data, root) {
  var i582 = root || request.c( 'UnityEngine.Events.PersistentCallGroup' )
  var i583 = data
  var i585 = i583[0]
  var i584 = new (System.Collections.Generic.List$1(Bridge.ns('UnityEngine.Events.PersistentCall')))
  for(var i = 0; i < i585.length; i += 1) {
    i584.add(request.d('UnityEngine.Events.PersistentCall', i585[i + 0]));
  }
  i582.m_Calls = i584
  return i582
}
...
Deserializers["UnityEngine.Events.PersistentCall"] = function (request, data, root) {
  var i588 = root || request.c( 'UnityEngine.Events.PersistentCall' )
  var i589 = data
  request.r(i589[0], i589[1], 0, i588, 'm_Target')
  i588.m_TargetAssemblyTypeName = i589[2]
  i588.m_MethodName = i589[3]
  i588.m_Mode = i589[4]
  i588.m_Arguments = request.d('UnityEngine.Events.ArgumentCache', i589[5], i588.m_Arguments)
  i588.m_CallState = i589[6]
  return i588
}
...
Deserializers["DropCustom"] = function (request, data, root) {
  var i598 = root || request.c( 'DropCustom' )
  var i599 = data
  request.r(i599[0], i599[1], 0, i598, 'skeletonGraphic')
  request.r(i599[2], i599[3], 0, i598, 'mixSkeletonSkin')
  return i598
}

Deserializers["Spine.Unity.SkeletonGraphic"] = function (request, data, root) {
  var i600 = root || request.c( 'Spine.Unity.SkeletonGraphic' )
  var i601 = data
  request.r(i601[0], i601[1], 0, i600, 'skeletonDataAsset')
  request.r(i601[2], i601[3], 0, i600, 'additiveMaterial')
  request.r(i601[4], i601[5], 0, i600, 'multiplyMaterial')
  request.r(i601[6], i601[7], 0, i600, 'screenMaterial')
  i600.initialSkinName = i601[8]
  i600.initialFlipX = !!i601[9]
  i600.initialFlipY = !!i601[10]
  i600.startingAnimation = i601[11]
  i600.startingLoop = !!i601[12]
  i600.timeScale = i601[13]
  i600.freeze = !!i601[14]
  i600.layoutScaleMode = i601[15]
  i600.updateWhenInvisible = i601[16]
  i600.allowMultipleCanvasRenderers = !!i601[17]
  var i603 = i601[18]
  var i602 = new (System.Collections.Generic.List$1(Bridge.ns('UnityEngine.CanvasRenderer')))
  for(var i = 0; i < i603.length; i += 2) {
  request.r(i603[i + 0], i603[i + 1], 1, i602, '')
  }
  i600.canvasRenderers = i602
  i600.enableSeparatorSlots = !!i601[19]
  i600.updateSeparatorPartLocation = !!i601[20]
  i600.updateSeparatorPartScale = !!i601[21]
  i600.disableMeshAssignmentOnOverride = !!i601[22]
  i600.referenceSize = new pc.Vec2( i601[23], i601[24] )
  i600.referenceScale = i601[25]
  i600.rectTransformSize = new pc.Vec2( i601[26], i601[27] )
  i600.editReferenceRect = !!i601[28]
  var i605 = i601[29]
  var i604 = []
  for(var i = 0; i < i605.length; i += 1) {
    i604.push( i605[i + 0] );
  }
  i600.separatorSlotNames = i604
  var i607 = i601[30]
  var i606 = new (System.Collections.Generic.List$1(Bridge.ns('UnityEngine.Transform')))
  for(var i = 0; i < i607.length; i += 2) {
  request.r(i607[i + 0], i607[i + 1], 1, i606, '')
  }
  i600.separatorParts = i606
  i600.meshGenerator = request.d('Spine.Unity.MeshGenerator', i601[31], i600.meshGenerator)
  i600.updateTiming = i601[32]
  i600.unscaledTime = !!i601[33]
  i600.m_Maskable = !!i601[34]
  request.r(i601[35], i601[36], 0, i600, 'm_Material')
  i600.m_Color = new pc.Color(i601[37], i601[38], i601[39], i601[40])
  i600.m_RaycastTarget = !!i601[41]
  i600.m_RaycastPadding = new pc.Vec4( i601[42], i601[43], i601[44], i601[45] )
  return i600
}

Deserializers["Spine.Unity.MeshGenerator"] = function (request, data, root) {
  var i614 = root || request.c( 'Spine.Unity.MeshGenerator' )
  var i615 = data
  i614.settings = request.d('Spine.Unity.MeshGenerator+Settings', i615[0], i614.settings)
  return i614
}

Deserializers["Spine.Unity.MeshGenerator+Settings"] = function (request, data, root) {
  var i616 = root || request.c( 'Spine.Unity.MeshGenerator+Settings' )
  var i617 = data
  i616.useClipping = !!i617[0]
  i616.zSpacing = i617[1]
  i616.pmaVertexColors = !!i617[2]
  i616.tintBlack = !!i617[3]
  i616.canvasGroupTintBlack = !!i617[4]
  i616.calculateTangents = !!i617[5]
  i616.addNormals = !!i617[6]
  i616.immutableTriangles = !!i617[7]
  return i616
}

Deserializers["MixSkeletonSkin"] = function (request, data, root) {
  var i618 = root || request.c( 'MixSkeletonSkin' )
  var i619 = data
  request.r(i619[0], i619[1], 0, i618, 'skeletonAnimation')
  var i621 = i619[2]
...
Deserializers["TMPro.VertexGradient"] = function (request, data, root) {
  var i644 = root || request.c( 'TMPro.VertexGradient' )
  var i645 = data
  i644.topLeft = new pc.Color(i645[0], i645[1], i645[2], i645[3])
  i644.topRight = new pc.Color(i645[4], i645[5], i645[6], i645[7])
  i644.bottomLeft = new pc.Color(i645[8], i645[9], i645[10], i645[11])
  i644.bottomRight = new pc.Color(i645[12], i645[13], i645[14], i645[15])
  return i644
}
...
Deserializers.lunaDaysRunning = "209.3";

Deserializers.lunaVersion = "6.4.0";

Deserializers.lunaSHA = "6639120529aa36186c6141b5c3fb20246c28bff0";

Deserializers.creativeName = "TBAP_V12_ManhND_AnhPD";
...
Deserializers.buildID = "11eb2adf-d1ae-4e94-8b03-cbd51d92546a";
