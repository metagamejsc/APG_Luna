...
internal static class LunaRectGeometry
{
    ...
    public static bool ContainsScreenPoint(RectTransform rect, [Bridge.Ref] Vector2 screenPoint, Camera camera)
    {
    ...
    public static Vector3 ScreenPointToWorldPoint(RectTransform planeRect, [Bridge.Ref] Vector2 screenPoint, Camera camera,
[Bridge.Ref]         Vector3 fallback)
    {
        Vector3 worldPoint;
        if (planeRect != null &&
