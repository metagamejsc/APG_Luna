...
namespace Playable
{
    public class TargetLevel37 : Target
    {
        ...
        private void PlayWin([Bridge.Ref] BoyInfo boy, List<AnimStep> animWinSteps)
        {
        ...
        private static GameObject GetBoyRoot([Bridge.Ref] BoyInfo boy)
        {
        ...
        private static bool IsBoyAlive([Bridge.Ref] BoyInfo boy)
        {
